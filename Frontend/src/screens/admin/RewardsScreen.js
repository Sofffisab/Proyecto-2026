...
//
// Rewards Screen (Admin) - spec section 26 ("Premios"):
// Read-only view with three sections — stock status, shipments in
// progress, and the waitlist for lack of stock — plus Back.
//
// Backend wiring:
...
//   PATCH /rewards/redemptions/:id -> mark a SHIPPED grant DELIVERED, which
//     moves it out of "in progress" into the app's full history (spec:
//     "Una vez el regalo llega a su destino, el registro se borra de esta
//     lista y se mueve al historial completo de la app").
