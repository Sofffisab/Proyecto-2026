...
// ============================================
// complaintService — simplified namespaced API
// ============================================
export const complaintService = {
  ...
  async resolve(id, resolution) {
    return prisma.complaint.update({
      where: { id },
      data: { status: "RESOLVED", reviewedAt: new Date(), resolution },
    });
  },

  async reject(id, resolution = null) {
    return prisma.complaint.update({
      where: { id },
      data: { status: "REJECTED", reviewedAt: new Date(), resolution },
    });
  },
